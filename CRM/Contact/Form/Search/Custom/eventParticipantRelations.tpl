    ...
    <div class="crm-accordion-body">
        ...
        <table class="form-layout-compressed">
            ...
            <tr class="crm-contact-custom-search-eventDetails-form-block-event_type">
                <td class="label">{ts}Event Types<br />(leave blank for any){/ts}</td>
                <td>     
            ...
            <tr class="crm-contact-custom-search-eventDetails-form-block-event_type">
                <td class="label">{ts}Participant Status<br />(leave blank for any){/ts}</td>
                <td>     
                    <div class="listing-box">
            ...
            <tr class="crm-contact-custom-search-eventDetails-form-block-event_type">
                <td class="label">{ts}Relationship Types<br />(please choose at least one){/ts}</td>
                <td>     
                    <div class="listing-box">
                        {foreach from=$form.relationship_type_id item="relationship_val"}
                            <div class="{cycle values="odd-row,even-row"}">
                                {$relationship_val.html}
                            </div>
                        {/foreach}
                    </div>
                    <div class="spacer"></div>
